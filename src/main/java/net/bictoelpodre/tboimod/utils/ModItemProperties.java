...
public class ModItemProperties {
    public static void addCustomItemProperties() {
        ItemProperties.register(ModedItems.SULFUR.get(), ResourceLocation.fromNamespaceAndPath(TheBindingOfIsaacMod.MOD_ID, "awakened"),
                (stack, level, entity, seed) -> level.isThundering() ? 1f : 0f);

        // makeCustomBow(ModedItems.GLASS_CANNON.get());
    }
